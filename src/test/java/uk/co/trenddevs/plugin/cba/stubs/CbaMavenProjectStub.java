package uk.co.trenddevs.plugin.cba.stubs;
...
public class CbaMavenProjectStub extends MavenProject  {

    private List attachedArtifacts;

    public CbaMavenProjectStub() {
        this("src/test/resources/unit/basic-cba-test/plugin-config.xml");
    }

    public CbaMavenProjectStub(String file) {
        super( new Model() );
        super.setGroupId( "org.apache.maven.test" );
        super.setArtifactId( "maven-cba-test" );
        super.setVersion( "1.0-SNAPSHOT" );
        super.setDescription( "Test description" );

        Organization org = new Organization();
        org.setName( "organization" );
        org.setUrl( "http://www.trenddevs.co.uk" );
        
        super.setOrganization( org );
        super.setFile( new File( getBasedir(), file) );
        ...
        super.addCompileSourceRoot( getBasedir() + "/src/test/resources/unit/basic-cba-test/src/main/java" );
        super.addTestCompileSourceRoot( getBasedir() + "/src/test/resources/unit/basic-cba-test/src/test/java" );
    ...
    public Artifact getArtifact() {
        return new CbaArtifactStub(getGroupId(), getArtifactId(), getVersion());
    }
